    ...
    <div className="bg-gray-50 dark:bg-slate-800 min-h-screen pb-20 pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            <h1 className="text-4xl font-black text-gray-900 dark:text-white tracking-tight">Active Engagements</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-1 font-medium italic">Monitor your contractual flow and milestone releases.</p>
          </div>
        ...
        {/* Action Bar */}
        <div className="bg-white dark:bg-slate-900 p-4 rounded-[2.5rem] border border-gray-100 dark:border-slate-700 shadow-sm mb-12 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                  ...
                  <div className="lg:col-span-2 text-center lg:text-left border-l border-gray-50 dark:border-slate-800 lg:pl-10">
                     ...
                     <p className="text-3xl font-black text-gray-900 dark:text-white leading-none tracking-tight">${contract.totalAmount}</p>
                  </div>
          ...
          {filteredContracts.length === 0 && (
            <div className="py-32 text-center bg-white dark:bg-slate-900 rounded-[4rem] border-2 border-dashed border-gray-100 dark:border-slate-700">
               <div className="max-w-xs mx-auto space-y-6">
                 ...
                 <h3 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight leading-none">No Contracts Found</h3>
                 <p className="text-gray-400 dark:text-gray-500 font-medium text-sm">You haven't initiated any professional engagements in this category yet.</p>
               </div>
            </div>
          )}
        </div>
