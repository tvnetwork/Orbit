    ...
    <footer className="bg-gray-900 text-white py-20 px-4 mt-auto">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-1 space-y-6">
          ...
          <p className="text-gray-400 dark:text-gray-500">{t('common.tagline')}</p>
        </div>
        <div>
          <h4 className="font-bold mb-6 text-sm uppercase tracking-widest text-gray-500 dark:text-gray-400">{t('nav.marketplace')}</h4>
      ...
      <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-gray-800 text-gray-500 dark:text-gray-400 text-sm flex flex-col md:flex-row justify-between gap-6">
